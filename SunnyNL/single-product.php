...
<body>
    ...
    <div class="wrapper">
                ...
                <form method="post" action="?product-key=<?php echo $_GET["product-key"]; ?>">
                    <div class="product-detail-btn">
                        <select name="SelectSize" class="btn" required>
                            <option value="" disabled selected hidden>Selecteer maat</option>
        ...
        <div class="dispriction">
            <nav>
                <button class="dispriction-btn active">BESCHRIJVING</button>
                <button class="dispriction-btn">EXTRA INFORMATIE</button>
